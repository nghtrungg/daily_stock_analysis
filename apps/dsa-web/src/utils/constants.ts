...
// Keep same-origin API requests by default so production/static builds do not
// accidentally send requests to the user's localhost. VITE_API_URL overrides it.
