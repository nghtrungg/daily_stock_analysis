...
This core-only build keeps documentation for CLI analysis, providers, reports, storage, scheduling, bots, and notifications.

- [Vietnam-local usage](vietnam-localization.md)
- [Bot commands](bot-command_EN.md)
- [Bot platform setup](bot/)
- [Notifications](notifications.md)
- [LLM configuration](llm-providers.md)
