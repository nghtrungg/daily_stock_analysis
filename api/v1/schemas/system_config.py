...
class TestNotificationChannelRequest(BaseModel):
    ...
    items: List[SystemConfigUpdateItem] = Field(default_factory=list)
    mask_token: str = "******"
    title: str = Field(default="DSA notification test", min_length=1, max_length=80)
    content: str = Field(default="This is a test message from the DSA Web settings page.", min_length=1, max_length=1000)
