...
class MainScheduleModeTestCase(unittest.TestCase):
    ...
    def test_runtime_file_logging_permission_error_falls_back_to_console(self) -> None:
        """Configured file logging failures should not prevent local startup."""
        import io
        ...
        self.assertIn("Check that the current Windows user can create and replace files", output)
