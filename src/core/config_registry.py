...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "ENABLE_VN_ADVANCED_FLOW": {
        "title": "Enable Vietnam Advanced Flow",
        "description": "Enable sponsor-only Vietnam foreign and proprietary flow data. Free order-flow data remains available when disabled.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "docs": [
            {
                "label": "Vietnam local configuration",
                "href": "docs/vietnam-localization.md#data-sources",
            },
        ],
        "warning_codes": ["sponsor_data_required"],
    },
    "NEWS_MAX_AGE_DAYS": {
    ...
    "SCHEDULE_TIMEZONE": {
        ...
        "description": "IANA timezone used to interpret SCHEDULE_TIME and SCHEDULE_TIMES.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["Asia/Ho_Chi_Minh"]},
        "display_order": 12,
        "help_key": "settings.system.schedule",
        "examples": ["SCHEDULE_TIMEZONE=Asia/Ho_Chi_Minh"],
        "docs": [
            {
                "label": "Vietnam local configuration",
                "href": "docs/vietnam-localization.md#schedule",
            },
        ],
