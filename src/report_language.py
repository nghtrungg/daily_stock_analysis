...
_OPERATION_ADVICE_TRANSLATIONS = {
    ...
    "watch": {"zh": "观望", "en": "Watch", "ko": "관망", "vi": "Theo dõi"},
...
_TREND_PREDICTION_TRANSLATIONS = {
    "strong_bullish": {"zh": "强烈看多", "en": "Strong Bullish", "ko": "강한 상승", "vi": "Rất tích cực"},
    "bullish": {"zh": "看多", "en": "Bullish", "ko": "상승", "vi": "Tích cực"},
    "sideways": {"zh": "震荡", "en": "Sideways", "ko": "횡보", "vi": "Đi ngang"},
    "bearish": {"zh": "看空", "en": "Bearish", "ko": "하락", "vi": "Tiêu cực"},
    "strong_bearish": {"zh": "强烈看空", "en": "Strong Bearish", "ko": "강한 하락", "vi": "Rất tiêu cực"},
}
...
_CHIP_HEALTH_TRANSLATIONS = {
    "healthy": {"zh": "健康", "en": "Healthy", "ko": "양호", "vi": "Tốt"},
    "average": {"zh": "一般", "en": "Average", "ko": "보통", "vi": "Trung bình"},
    "caution": {"zh": "警惕", "en": "Caution", "ko": "주의", "vi": "Cảnh báo"},
}
...
_BIAS_STATUS_TRANSLATIONS = {
    ...
    "caution": {"zh": "警戒", "en": "Caution", "ko": "경계", "vi": "Thận trọng"},
    "danger": {"zh": "危险", "en": "Danger", "ko": "위험", "vi": "Rủi ro"},
}
...
_CHIP_UNAVAILABLE_BY_LANGUAGE = {
    ...
    "vi": "Dữ liệu cơ cấu nắm giữ chưa bật hoặc tạm thời không khả dụng; không dùng tín hiệu này.",
}
...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "ma50_label": "MA50",
        "ma200_label": "MA200",
        "long_term_warning_label": "长期趋势警告",
        "bias_ma5_label": "乖离率(MA5)",
        "support_level_label": "支撑位",
        "resistance_level_label": "压力位",
        "chip_label": "筹码",
        "order_flow_label": "主动买卖压力",
        "active_buy_label": "主动买入量",
        "active_sell_label": "主动卖出量",
        "active_imbalance_label": "主动买卖差",
        "foreign_net_label": "外资净流",
        "proprietary_net_label": "自营净流",
        ...
        "sector_health_heading": "行业健康度",
        "sector_health_peers_label": "同行样本",
        "sector_health_unavailable": "行业样本不足，未计算评分",
        "decision_scenarios_heading": "决策情景",
        "scenario_condition_label": "触发条件",
        "scenario_action_label": "应对动作",
        "scenario_invalidation_label": "失效/撤销条件",
        "closing_summary_heading": "报告结论摘要",
    ...
    "en": {
        ...
        "ma50_label": "MA50",
        "ma200_label": "MA200",
        "long_term_warning_label": "Long-term Trend Warning",
        "bias_ma5_label": "Bias (MA5)",
        "support_level_label": "Support",
        "resistance_level_label": "Resistance",
        "chip_label": "Chip Structure",
        "order_flow_label": "Active Order Flow",
        "active_buy_label": "Active Buy Volume",
        "active_sell_label": "Active Sell Volume",
        "active_imbalance_label": "Active Imbalance",
        "foreign_net_label": "Foreign Net Flow",
        "proprietary_net_label": "Proprietary Net Flow",
        ...
        "sector_health_heading": "Sector Health",
        "sector_health_peers_label": "Peer Sample",
        "sector_health_unavailable": "Insufficient sector evidence; score not calculated",
        "decision_scenarios_heading": "Decision Scenarios",
        "scenario_condition_label": "Trigger",
        "scenario_action_label": "Action",
        "scenario_invalidation_label": "Invalidation",
        "closing_summary_heading": "Closing Summary",
        ...
        "operation_reason_label": "Operation Rationale",
    ...
    "vi": {
        ...
        "buy_label": "Mua",
        "watch_label": "Theo dõi",
        "sell_label": "Bán",
        "summary_heading": "Tóm tắt",
        "info_heading": "Cập nhật chính",
        "sentiment_summary_label": "Tâm lý",
        ...
        "one_sentence_label": "Quyết định một dòng",
        ...
        "price_metrics_label": "Chỉ báo giá",
        "ma5_label": "MA5",
        "ma10_label": "MA10",
        "ma20_label": "MA20",
        "ma50_label": "MA50",
        "ma200_label": "MA200",
        "long_term_warning_label": "Cảnh báo xu hướng dài hạn",
        "bias_ma5_label": "Độ lệch (MA5)",
        "support_level_label": "Hỗ trợ",
        "resistance_level_label": "Kháng cự",
        "chip_label": "Cơ cấu nắm giữ",
        "order_flow_label": "Áp lực mua/bán chủ động",
        "active_buy_label": "Khối lượng Buy Up",
        "active_sell_label": "Khối lượng Sell Down",
        "active_imbalance_label": "Chênh lệch chủ động",
        "foreign_net_label": "Khối ngoại ròng",
        "proprietary_net_label": "Tự doanh ròng",
        "phase_decision_heading": "Lan can quyết định theo phiên",
        ...
        "sector_health_heading": "Sức khỏe nhóm ngành",
        "sector_health_peers_label": "Mẫu so sánh",
        "sector_health_unavailable": "Chưa đủ dữ liệu nhóm ngành để tính điểm",
        "decision_scenarios_heading": "Kịch bản quyết định",
        "scenario_condition_label": "Điều kiện kích hoạt",
        "scenario_action_label": "Hành động",
        "scenario_invalidation_label": "Điều kiện hủy",
        "closing_summary_heading": "Tổng hợp cuối báo cáo",
        ...
        "action_points_heading": "Vùng giá hành động",
        "position_advice_heading": "Khuyến nghị vị thế",
        "analysis_model_label": "Mô hình",
        "not_investment_advice": "Nội dung do AI tạo chỉ để tham khảo, không phải khuyến nghị đầu tư.",
        ...
        "operating_cash_flow_label": "Dòng tiền kinh doanh",
        "roe_label": "ROE",
        "revenue_yoy_label": "Doanh thu YoY",
        "net_profit_yoy_label": "Lợi nhuận YoY",
        "gross_margin_label": "Biên lợi nhuận gộp",
        "shareholder_return_heading": "Hoàn vốn cổ đông",
        "ttm_cash_dividend_label": "Cổ tức tiền mặt 12T/cp (trước thuế)",
        "ttm_event_count_label": "Số lần cổ tức 12T",
        "ttm_dividend_yield_label": "Tỷ suất cổ tức TTM",
        "latest_ex_dividend_label": "Ngày GDKHQ gần nhất",
        "institutional_flow_heading": "Dòng tiền tổ chức",
        "institutional_flow_note": "Dương=mua ròng, âm=bán ròng; đơn vị: cổ phiếu.",
        "inst_foreign_label": "Nước ngoài",
        "inst_trust_label": "Quỹ",
        "inst_dealer_label": "Tự doanh",
        "inst_total_label": "Tổng tổ chức",
        "related_boards_heading": "Nhóm liên quan",
        "industry_boards_heading": "Nhóm ngành",
        "concept_boards_heading": "Chủ đề",
        "board_name_label": "Nhóm",
        "board_type_label": "Loại",
        "board_status_label": "Trạng thái",
        "board_change_pct_label": "% thay đổi",
        "leading_board_label": "Dẫn dắt",
        "lagging_board_label": "Yếu hơn",
        "signal_attribution_heading": "Phân rã tín hiệu",
        "attribution_weights_label": "Trọng số",
        "technical_indicators_label": "Chỉ báo kỹ thuật",
        "news_sentiment_label": "Tâm lý tin tức",
        "fundamentals_label": "Cơ bản",
        "market_conditions_label": "Điều kiện thị trường",
        "strongest_bullish_signal_label": "Tín hiệu tích cực mạnh nhất",
        "strongest_bearish_signal_label": "Tín hiệu tiêu cực mạnh nhất",
        "operation_reason_label": "Lý do khuyến nghị",
    ...
    "ko": {
        ...
        "ma50_label": "MA50",
        "ma200_label": "MA200",
        "long_term_warning_label": "장기 추세 경고",
        "bias_ma5_label": "이격도(MA5)",
        "support_level_label": "지지선",
        "resistance_level_label": "저항선",
        "chip_label": "매물대",
        "order_flow_label": "적극 주문 흐름",
        "active_buy_label": "적극 매수량",
        "active_sell_label": "적극 매도량",
        "active_imbalance_label": "적극 수급 불균형",
        "foreign_net_label": "외국인 순매매",
        "proprietary_net_label": "자기매매 순매매",
        ...
        "sector_health_heading": "업종 건전성",
        "sector_health_peers_label": "비교 표본",
        "sector_health_unavailable": "업종 근거가 부족하여 점수를 계산하지 않음",
        "decision_scenarios_heading": "의사결정 시나리오",
        "scenario_condition_label": "조건",
        "scenario_action_label": "대응",
        "scenario_invalidation_label": "무효화 조건",
        "closing_summary_heading": "최종 요약",
        ...
        "operation_reason_label": "대응 근거",
        "risk_warning_label": "위험 경고",
    },
}
