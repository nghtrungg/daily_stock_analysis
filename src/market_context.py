...
def get_market_role(stock_code: Optional[str], lang: str = "zh") -> str:
    ...
    # Vietnamese reports use the English operational prompt copy; the output
    # language section separately requires Vietnamese narrative values.
    lang_key = "en" if lang in ("en", "ko", "vi") else "zh"
